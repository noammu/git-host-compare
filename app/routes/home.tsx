...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "GitHub vs GitLab - Comprehensive Platform Comparison" },
    {
      name: "description",
      content:
        "An objective, detailed comparison between GitHub and GitLab, plus alternative code hosting platforms to help you choose the right tool for your team.",
    },
  ];
}
...
const alternatives = [
  {
    ...
    description:
      "Atlassian's Git solution with deep Jira integration, ideal for teams already in the Atlassian ecosystem.",
  ...
  },
  {
    ...
    description:
      "Microsoft's comprehensive DevOps platform offering repos, pipelines, boards, and artifacts in one place.",
  ...
  },
  {
    ...
    description:
      "Lightweight, self-hosted Git service written in Go, offering simplicity and minimal resource requirements.",
  ...
  },
  {
    ...
    description:
      "One of the oldest code hosting platforms, supporting Git, SVN, and Mercurial with project management tools.",
  ...
  },
  {
    ...
    description:
      "Harness's open-source DevOps platform combining code hosting with pipelines in a lightweight package.",
    ...
    <div className={styles.page}>
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <h1>fghfghfdghjrfgj dfjgh dfgjdfgj</h1>
        ...
        <div className={styles.overviewGrid}>
          <Card className={styles.platformCard}>
            ...
            <CardContent>
              <ul className={styles.featureList}>
                <li>
                  <Check className={styles.checkIcon} /> 100M+ developers
                </li>
                <li>
                  <Check className={styles.checkIcon} /> Dominant in open source
                </li>
                <li>
                  <Check className={styles.checkIcon} /> Extensive marketplace
                </li>
                <li>
                  <Check className={styles.checkIcon} /> GitHub Actions for CI/CD
                </li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card className={styles.platformCard}>
            ...
            <CardContent>
              <ul className={styles.featureList}>
                <li>
                  <Check className={styles.checkIcon} /> Built-in CI/CD pipelines
                </li>
                <li>
                  <Check className={styles.checkIcon} /> All-in-one DevOps
                </li>
                <li>
                  <Check className={styles.checkIcon} /> Self-hosted option
                </li>
                <li>
                  <Check className={styles.checkIcon} /> Comprehensive security
                </li>
              </ul>
            </CardContent>
          </Card>
      ...
      <section className={styles.comparisonTable}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionDescription}>A detailed breakdown of capabilities across key categories</p>
        </div>
        ...
        <div className={styles.footerContent}>
          <div className={styles.footerSection}>
            ...
            <p className={styles.footerDescription}>
              An objective resource for comparing code hosting platforms. Information is regularly updated to reflect
          ...
          <div className={styles.footerSection}>
            ...
            <p className={styles.footerNote}>
              This is an independent comparison resource. We are not affiliated with GitHub, GitLab, or any other
              platforms mentioned. All trademarks belong to their respective owners.
            </p>
          </div>
        </div>
